...
import 'package:Freight4u/pages/hnlpolicy/speedingpolicy/speedingpolicy.view.dart';
import 'package:Freight4u/pages/hnlpolicy/nosmokingpolicy/nosmokingpolicy.view.dart';
            ...
            body: SingleChildScrollView(
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    textH1("HUNTER & NORTHERN GROUP POLICIES :"),
                    ...
                    customBox(
                      ...
                      onTap: () =>
                          Get.to(context, () => const SpeedingpolicyPage()),
                    ),
                    ...
                    customBox(
                      ...
                      onTap: () =>
                          Get.to(context, () => const Nosmokingpolicy()),
                    ),
                    const SizedBox(height: 10),
                    customBox(
                    ...
                    const SizedBox(height: 10),
                    customBox(
                      text: "Chain of Responsibility - Policy Statement",
                      subtext:
